      ...
      {books.map((book) => (
        <div className="w-72 m-4 flex flex-col justify-center items-center shadow-md border py-4 rounded-lg">
          ...
          <div className="px-6 py-4 w-full">
            ...
            <div>
            <p
                  className={`inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 capitalize dark:focus:ring-blue-800 ${book.status === 'order received' ? 'bg-green-500' : 'bg-theme'}`}
                >
                  {book.status}
                </p>
            </div>
